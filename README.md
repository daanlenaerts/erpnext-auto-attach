...
- Files and directories starting with a dot (`.`) or underscore (`_`) are ignored
...
- [Linux x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/eaa-linux-x64)
- [macOS arm64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/eaa-macos-arm64)
- [macOS x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/eaa-macos-x64)
- [Windows x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/eaa-windows-x64.exe)
- [Windows x64 (baseline)](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/eaa-windows-x64-baseline.exe)
