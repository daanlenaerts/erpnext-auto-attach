...
- [Linux x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/download/v1.1.0/eaa-linux-x64)
- [macOS arm64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/download/v1.1.0/eaa-macos-arm64)
- [macOS x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/download/v1.1.0/eaa-macos-x64)
- [Windows x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/download/v1.1.0/eaa-windows-x64.exe)
- [Windows x64 (baseline)](https://github.com/daanlenaerts/erpnext-auto-attach/releases/download/v1.1.0/eaa-windows-x64-baseline.exe)
